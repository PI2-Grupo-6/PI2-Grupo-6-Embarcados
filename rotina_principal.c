...
#define Eq2 2                                                           // servir alimento quente 1
...
void ServirAlimentos(int bocal, char qtde);
    ...
    case E0:
    {
        ...
        if(q != 0 || f != 0)
        {
            ...
            do
            {
                ...
                pwmWrite (12, 5);                                       // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
        ...
        void Executa_fsm_quente(void)
        {
            ...
            case Eq1:
            {
                if(quentes[0]== 's')                                //deseja alimento 0.
                {
                    ...
                    {
                        digitalWrite(5, HIGH);                      // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                        pwmWrite (12, 5);                           // escreve o sinal pwm no pino 12, para mover o motor do prato
                        // foi definido 6 rpm como velocidade. Precisamos girar 22,5 graus , logo 12,5 passos como 20 hz de frequencia durante 625ms
                        Sleep(1);                                   // programa aguarda 1ms antes de incrementar a variavel segundo
                        inst++;                                     // conta q quantidade de ms incrementados
                    }
                    while( inst <= 625);                            // executa o pulso enquanto o contador não atinge o tempo
                }
                else if(quentes[0]=='n');                           // não deseja alimento 0
                {
                    ...
                    {
                        digitalWrite(5, HIGH);                     // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                        pwmWrite (12, 5);                           // escreve o sinal pwm no pino 18,com largura de pulso de 10ms e frequencia de 100Hz
            ...
            case Eq2:                                               // estado de servir o alimento 0
            {
                ...
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[0], quentes[0]);
            ...
            case Eq4:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[1], quentes[1]);
            ...
            case Eq6:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[2], quentes[2]);
            ...
            case Eq8:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[3], quentes[3]);
            ...
            case Eq10:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[4], quentes[4]);
            ...
            case Eq12:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[5], quentes[5]);
            ...
            case Eq14:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[6], quentes[6]);
            ...
            case Eq16:
            {
                ...
                digitalWrite(19, LOW);  							// b na seleção do demux
                digitalWrite(16, LOW);                        		// a na seleção do demux
                ServirAlimentos(bocal[7], quentes[7]);
    ...
    case E4:
    {
        ...
        void Executa_fsm_frio(void)
        {
            ...
            case Ef2:                                               // estado de servir o alimento 0
            {
                ...
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[8], frios[0]);
            ...
            case Ef4:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[9], frios[1]);
            ...
            case Ef6:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[10], frios[2]);
            ...
            case Ef8:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[11], frios[3]);
            ...
            case Ef10:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[12], frios[4]);
            ...
            case Ef12:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[13], frios[5]);
            ...
            case Ef14:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[14], frios[6]);
            ...
            case Ef16:
            {
                ...
                digitalWrite(19, HIGH);  							// b na seleção do demux
                digitalWrite(16, HIGH);                        		// a na seleção do demux
                ServirAlimentos(bocal[15], frios[7]);
        ...
        ControleMaquinaEstado = E5;                                     // movimenta o fuso para o ponto final
        digitalWrite(20, LOW);                                          // c na seleção do demux
        digitalWrite(19, HIGH);          //MOTOR DO FUSO                // b na seleção do demux
        digitalWrite(16, LOW);                                          // a na seleção do demux
        ...
        {
            digitalWrite(5, HIGH);                                     // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
            pwmWrite (12, 5);                                           // escreve o sinal pwm no pino 12,com largura de pulso de 1ms e frequencia de 1000Hz
    ...
    if (bocal== 1)
    {
        if (qtde == 'p')
        {
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 630 ms = 9 passos = 16,2 graus
                Sleep(1);                                       // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                          // conta a quantidade de ms incrementado
            }
            while( seg <= 630);                                 // executa o pulso enquanto o contador não atinge o tempo
            Sleep(300);						                    // programa aguarda 300ms antes de continuar
            do
            {
                digitalWrite(5, LOW);                           // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
        ...
        else if (qtde == 'm')
        {
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 1190 ms = 17 passos = 30,6 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 1190);                            // executa o pulso enquanto o contador não atinge o tempo
            Sleep(300);						// programa aguarda 300ms antes de continuar
            do
            {
                digitalWrite(5, LOW);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
        ...
        else if (qtde == 'g')
        {
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 1750 ms = 25 passos = 45 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 1750);                            // executa o pulso enquanto o contador não atinge o tempo
            Sleep(300);						    // programa aguarda 300ms antes de continuar
            do
            {
                digitalWrite(5, LOW);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
    ...
    else if (bocal== 4)
    {
        if (qtde == 'p')
        {
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 2310 ms = 33 passos = 60 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 2310);                            // executa o pulso enquanto o contador não atinge o tempo
        }
        else if (qtde == 'm')
        {
            int seg = 0;                                    // contador de segundo iniciado em zero
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 4690 ms = 67 passos = 120 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 4690);                            // executa o pulso enquanto o contador não atinge o tempo
        }
        else if (qtde == 'g')
        {
            int seg = 0;                                    // contador de segundo iniciado em zero
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 7000 ms = 100 passos = 180 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 7000);                            // executa o pulso enquanto o contador não atinge o tempo
        }
    }
    ...
    else if (bocal == 6)
    {
        if (qtde == 'p')
        {
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 3500 ms = 50 passos = 90 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 3500);                            // executa o pulso enquanto o contador não atinge o tempo
        }
        else if (qtde == 'm')
        {
            int seg = 0;                                    // contador de segundo iniciado em zero
            ...
            while( segundo <= 7000);                            // executa o pulso enquanto o contador não atinge o tempo
        }
        else if (qtde == 'g')
        {
            int seg = 0;                                    // contador de segundo iniciado em zero
            ...
            do
            {
                digitalWrite(5, HIGH);                          // Determina o sentido de giro do motor. Nível alto representa sentido horário e nível baixo representa sentido anti-horário
                pwmWrite (12, 5);                               // escreve o sinal pwm no pino 12,com largura de pulso de 10ms e frequencia de 100Hz
                //  14,2857142857 Hz x 7000 ms = 150 passos = 270 graus
                Sleep(1);                                            // programa aguarda 1ms antes de incrementar a variavel segundo
                seg++;                                               // conta a quantidade de ms incrementado
            }
            while( seg <= 10500);                            // executa o pulso enquanto o contador não atinge o tempo
        }
    }
}
